...
g();
f();
console.dir(f); //RE-assigning f function

h();
f();
console.dir(f); //Example 2

var boardPassengers = function boardPassengers(n, wait) {
  var perGroup = n / 3; //settimeout funct will execute after 3 sec
...
boardPassengers(180, 3); // setTimeout(function () {
//   console.log('TIMER');
// }, 1000);
